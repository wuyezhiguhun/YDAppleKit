...
- (void)reloadUIWhenLanguageChange {
    self.titleList = @[YDLanguage(@"YDNetworkingModule"),YDLanguage(@"YDFactoryPattern"),YDLanguage(@"YDFactoryMap"),YDLanguage(@"YDSingletonPattern"),YDLanguage(@"YDWebViewPattern")];
...
- (NSArray *)titleList {
    if (!_titleList) {
        _titleList = @[YDLanguage(@"YDNetworkingModule"),YDLanguage(@"YDFactoryPattern"),YDLanguage(@"YDFactoryMap"),YDLanguage(@"YDSingletonPattern"),YDLanguage(@"YDWebViewPattern")];
    }
    return _titleList;
}
- (NSArray *)routerList {
    if (!_routerList) {
        _routerList = @[YDModuleRouterNetworkingUrl,YDModuleRouterFactoryUrl,YDModuleRouterFactoryMapUrl,YDModuleRouterSingletonUrl,YDModuleRouterWebViewUrl];
    }
    return _routerList;
}
